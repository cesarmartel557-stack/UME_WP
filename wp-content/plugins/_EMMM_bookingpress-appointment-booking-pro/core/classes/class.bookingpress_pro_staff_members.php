			...
			if(!empty($service_timings) && !empty( $get_appointments ) ){
				foreach( $service_timings as $k => $service_timing_data ){
					...
					foreach( $get_appointments as $get_appointment ){
						...
						$booked_appointment_start_date = ( !empty( $get_appointment->booked_appointment_date ) && '0000-00-00' != $get_appointment->booked_appointment_date ) ? $get_appointment->booked_appointment_date : $selected_date;
                  		$booked_appointment_end_date = ( !empty( $get_appointment->booked_appointment_end_date ) && '0000-00-00' != $get_appointment->booked_appointment_end_date ) ? $get_appointment->booked_appointment_end_date : $booked_appointment_start_date;
