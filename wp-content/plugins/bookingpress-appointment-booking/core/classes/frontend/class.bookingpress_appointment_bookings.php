...
/*print_r( ($BookingPress->bpa_is_pro_active()?'si':'no').$BookingPress->bpa_pro_plugin_version()."       
     ----- $use_legacy                
");exit;*/
...
$response = array_merge($response, array("default"=> $bpa_retrieves_default_disabled_dates, "posted"=> $posted_disabled_dates ) );
