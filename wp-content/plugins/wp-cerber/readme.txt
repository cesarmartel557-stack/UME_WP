...
New: The Live Traffic log now highlights 301 and 302 redirections and separately marks those triggered by WP Cerber for better visibility.
...
Improved: SQL queries for WP Cerber’s admin pages are now cached in WordPress’s object cache, reducing database requests and speeding up page loads.
...
Fixed: A bug causing repeated translation update requests has been fixed, ensuring efficient translation management.
