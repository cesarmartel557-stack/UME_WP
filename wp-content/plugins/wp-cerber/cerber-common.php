 ...
 *
 * @return string Client IP address, or CERBER_NO_REMOTE_IP if the IP address unavailable.
 *
 * @since 6.0
 *
 * @version Sequoia
 ...
 *
 * Special case: a literal '#' is returned as-is for compatibility with placeholder or interactive JS links.
 *
