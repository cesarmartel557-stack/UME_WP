...
if ( ! class_exists( 'bookingpress_pro_timesheet' ) ) {
	class bookingpress_pro_timesheet Extends BookingPress_Core {
		...
		function bookingpress_get_timesheet_daysoff_details_func() {
			global $wpdb, $BookingPress, $tbl_bookingpress_staffmembers, $tbl_bookingpress_staffmembers_daysoff,$bookingpress_global_options, $bookingpress_pro_staff_members;
			$response            = array();
			...
			if ( ! empty( $bookingpress_staffmember_id ) ) {
				...
				foreach ( $bookingpress_staffmember_daysoff_details as $key => $value ) {
					...
					if( true == $value['bookingpress_staffmember_daysoff_repeat'] ){
						...
						$dayoff_label = $bookingpress_pro_staff_members->bookingpress_retrieve_daysoff_repeat_label( $repeat_duration, $repeat_frequency, $repeat_frequency_type, $repeat_times, $repeat_date );
					}
