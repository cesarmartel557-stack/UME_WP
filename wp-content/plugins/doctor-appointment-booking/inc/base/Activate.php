...
class Activate
{
	...
	// Method for adding appointment table in wp database
	private static function setup_appointment_table() {
		global $wpdb;
	...
	// Method for adding chamber table in wp database
	private static function setup_chamber_table() {
		global $wpdb;
	...
	// Method for adding patient table in wp database
	private static function setup_patient_table() {
		global $wpdb;
	...
	// Method for adding prescription table in wp database
	private static function setup_prescription_table() {
		global $wpdb;
	...
	private static function insert_default_data() {
		self::insert_default_chamber();
		self::insert_country_data();
		self::insert_settings_data();
	}

	// Method for inserting a chamber for the doctor by default
	private static function insert_default_chamber() {
		global $wpdb;
		$table = $wpdb->prefix . 'ctmdcd_chamber';
		$sql = "INSERT INTO $table (`chamber_id`, `name`, `address`, `schedule`, `status`) VALUES 
