...
<el-main class="bpa-main-listing-card-container bpa-default-card bpa--is-page-non-scrollable-mob" :class="(bookingpress_staff_customize_view == 1 ) ? 'bpa-main-list-card__is-staff-custom-view':''" id="all-page-main-container">
 ...
 <div class="historias_y_pacientes" style="" >
					...
					<div class="bpa-tc__wrapper"  >
						<el-table ref="multipleTable" :data="items" @selection-change="handleSelectionChange">
							...
							<el-table-column  prop="customer_fullname" label="<?php esc_html_e( 'Nombre', 'bookingpress-appointment-booking' ); ?>" sortable sort-by="customer_username">
                                ...
                                <a class="link-paciente " onclick="document.querySelectorAll('.link-paciente').forEach((a_el)=> a_el.classList.remove('activo')); this.classList.add('activo');" @click="()=>{document.body.style.cursor='wait';  setTimeout(()=>{document.body.style.cursor='';},3000); }" >											
									...
									<div class="bpa-table-actions-wrap">
										...
										<div class="bpa-table-actions">												
                                            ...
                                            <el-tooltip effect="dark" content="" placement="top" open-delay="300">
												...
												<el-button class="bpa-btn bpa-btn--icon-without-box" @click.native.prevent="editCustomerDetails(scope.row.customer_id)" style="border-radius: 3px;">
    ...
    <div class="el-row main-historias" >
        ...
        <div class="lista-historias-container">
            ...
            <div class="lista-historias" >
                <div class="historia-item" data-historia="2024 08-12">
                    <div><strong>Medico</strong> <strong style="float: right;">2024-08-12</strong></div><br />
                    Alergias:<br />
                    Antecedentes:<br />
                    Medicamentos:<br />
                </div>
                <div class="historia-item" data-historia="2024 08-10">
                    <div><strong>Medico</strong> <strong style="float: right;">2024-08-10</strong></div><br />
                    Alergias:<br />
                    Antecedentes:<br />
                    Medicamentos:<br />
                </div>
                <div class="historia-item" data-historia="2024 08-02">
                    <div><strong>Medico</strong> <strong style="float: right;">2024-08-02</strong></div><br />
                    Alergias:<br />
                    Antecedentes:<br />
                    Medicamentos:<br />
                </div>
