...
$test_json='{
    "selected_category" : "1", 
    "selected_service" : "2", 
    "selected_service_name" :"Cardiología", 
    ...
    , "customer_phone_dial_code" : "54", "bookingpress_customer_timezone" : 180,
        ...
        "customer_firstname" : "NOMBRE", "customer_lastname" : "APELLIDO",
            ...
            "customer_phone_country" : "AR", "text_C6kufq" : "11111", "text_o9q4Cr" : "",
...
//ruiz 31 natalia 352 davv gyoker 88 harasiwka 339 id:19 
$prestador = 339;
$medico_id = 19;
...
if( !empty( file_get_contents(__DIR__.'/resultado_'.$prestador.'_'.$turno_man_tarde.'.txt') )) exit("ya existe resultado $turno_man_tarde");

$f = file_get_contents(__DIR__.'/turnos_json'.$prestador.'_'.$turno_man_tarde.'.txt') ;
$f = str_replace(array("\n\r","\n","\r"),'', $f);
...
IF( isset($_GET['mostrar'])){
    ECHO "<br />mostrar ID PRESTADOR $prestador . ID MEDICO $medico_id .<br /><br />";
...
if( $datos_turno[$indx]['ID_PRESTADOR'] == $prestador && ( strtolower($datos_turno[$indx]['TURNO']) == $turno_man_tarde) ){
    ...
    $doc = (string) $datos_turno[$indx]["NRODOCUMENTO"];
    echo $doc;
    echo "<br />";
...
$escribe_result = fopen(__DIR__ .'/resultado_'.$prestador.'_'.$turno_man_tarde.'.txt','a');
if($escribe_result){
