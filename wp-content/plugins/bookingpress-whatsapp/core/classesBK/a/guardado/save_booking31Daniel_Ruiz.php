...
$test_json='{
    ...
    , "customer_phone_dial_code" : "54", "bookingpress_customer_timezone" : 180,
        "bookingpress_form_token" : "66c4e57bbdf6f_1j6cu66r58", "form_fields" : {
        "customer_firstname" : "NOMBRE", "customer_lastname" : "APELLIDO",
            "customer_email" : "", "customer_phone" : "+54 364 445 0913",
            "customer_phone_country" : "AR", "text_C6kufq" : "34041389", "text_o9q4Cr" : "",
    ...
    , "bookingpress_deposit_payment_method" : "deposit_or_full_price",
        ...
        "selected_staff_member_id" : "40", 
        "staff_member_id" : "40",
            "select_any_staffmember" : "false", "is_any_staff_option_selected" : 0}
    , "selected_staff_member_id" : "40", "is_extra_service_exists" : 0,
        ...
        "stime" : 1724194756, "spam_captcha" : "QWcqrlw0YsJ7", "bookingpress_uniq_id" :
        "66c4e57bbdf6f", "bookingpress_captcha_66c4e57bbdf6f" : "",
        "base_price_without_currency" : "0", "multiple_quantity_token" :
        "NjZjNGU1N2JiZGY2ZjFmNmZkYmI3NWU0YzY2", "any_staff_selected" : 0,
...
echo count($horario['mañana'])."<br /><br />horario turno<br />";
...
if( $datos_turno[$indx]['ID_PRESTADOR'] == $prestador){
    ...
    $doc = (int) $datos_turno[$indx]['NRODOCUMENTO'];
    echo $doc;
    echo "<br />";
    ...
    echo " indx_hora_turno: ".$nro_turno;
    echo "<br />";
    $turno_en_horas = $horario['mañana'][$nro_turno];
...
//print_r($horario['mañana'][$nro_turno]);
