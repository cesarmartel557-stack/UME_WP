...
//ruiz 31 natalia 352 davv gyoker 88 harasiwka 339 id:19    marisa 276 id:25
$prestador = 276;
$medico_id = 25;
...
$f = file_get_contents(__DIR__.'/turnos_json'.$prestador.'.txt');
$f = str_replace(array("\n\r","\n","\r"),'', $f);
