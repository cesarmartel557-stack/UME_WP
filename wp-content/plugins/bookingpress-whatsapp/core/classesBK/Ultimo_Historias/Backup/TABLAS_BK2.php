...
class BookingPress_Expansion_Plugin {
    ...
    public function init_plugin(){
        ...
        if( !empty($this->require_update) ) echo " actualizandooooooooooo";
    ...
    public function get_options(){
        $options = get_option('BPHistoriasC_options', []);
    ...
    public function update_options( $new_options = []){
        ...
        $updt = update_option('BPHistoriasC_options', $options );
    ...
    function check_update_time(){
        ...
        if( time() > ($last_check_time + $expire) ){
            ...
            echo "ultimo -- $last_check_time--- time:".time() . ' ___ ' ;
