...
$test_json='{
    "selected_category" : "1", 
    "selected_service" : "9", 
    "selected_service_name" :"Cirugía General", 
 ...
 * 43-BRAVO GERARDO LUIS id:9 serv:9 Cirugía General
 */

$prestador = 43;//179
$medico_id = 9; //47 serv 17 Traumatología
...
if( $datos_turno[$indx]['ID_PRESTADOR'] == $prestador  ){
    ...
    if($nro_turno <0) $nro_turno=0;
         ...
         * Exapcion dia viernes
         ...
         //Exapcion dia viernes
         if( date("D", strtotime($date)) == "Fri" ){
            echo " friday $nro_turno <br />";
            
        }else{
            //$nro_turno = 2+ $nro_turno;
            echo " NO-friday $nro_turno <br />";
        }
