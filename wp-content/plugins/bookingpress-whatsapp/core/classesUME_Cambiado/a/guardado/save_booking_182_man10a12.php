...
$str_tarde= ($turno_man_tarde=='tarde')? "_tarde_mier":"";
...
if( $datos_turno[$indx]['ID_PRESTADOR'] == $prestador  ){
    ...
    //Exapcion dia viernes
         ...
         if( date("D", strtotime($date)) == "Mon" ){
            echo " ESLUNES NO guardar $nro_turno <br />";
            continue;
        }else{
            //$nro_turno = 2+ $nro_turno;
            echo " NOLUNES $nro_turno <br />";
