...
$horario['mañana']=json_decode('[
    ...
    },
    {
        ...
        "break_start_time": "",
        "break_end_time": "",
        "store_start_time": "12:00",
        "store_end_time": "12:15",
        "store_service_date": "2024-08-27",
        "is_booked": 0,
        "max_capacity": "1",
        "total_booked": 0,
        ...
        "formatted_start_time": "12:00",
        "formatted_end_time": "12:15",
        "formatted_start_end_time": "12:00 - 12:15",
        "class": ""
    },
    {
        "start_time": "12:15",
        ...
        "break_start_time": "",
        "break_end_time": "",
        "store_start_time": "12:15",
        "store_end_time": "12:30",
        "store_service_date": "2024-08-27",
        "is_booked": 0,
        "max_capacity": "1",
        "total_booked": 0,
        ...
        "formatted_start_time": "12:15",
        "formatted_end_time": "12:30",
        "formatted_start_end_time": "12:15 - 12:30",
        "class": ""
    },
    {
        "start_time": "12:30",
        ...
        "break_start_time": "",
        "break_end_time": "",
        "store_start_time": "12:30",
        "store_end_time": "12:45",
        "store_service_date": "2024-08-27",
        "is_booked": 0,
        "max_capacity": "1",
        "total_booked": 0,
        ...
        "formatted_start_time": "12:30",
        "formatted_end_time": "12:45",
        "formatted_start_end_time": "12:30 - 12:45",
        "class": ""
    },
    {
        "start_time": "12:45",
        ...
        "break_start_time": "",
        "break_end_time": "",
        "store_start_time": "12:45",
        "store_end_time": "13:00",
        "store_service_date": "2024-08-27",
        "is_booked": 0,
        "max_capacity": "1",
        "total_booked": 0,
        ...
        "formatted_start_time": "12:45",
        "formatted_end_time": "13:00",
        "formatted_start_end_time": "12:45 - 13:00",
        "class": ""
    },
    {
        "start_time": "13:00",
        ...
        "break_start_time": "",
        "break_end_time": "",
        "store_start_time": "13:00",
        "store_end_time": "13:15",
        "store_service_date": "2024-08-27",
        "is_booked": 0,
        "max_capacity": "1",
        "total_booked": 0,
        ...
        "formatted_start_time": "13:00",
        "formatted_end_time": "13:15",
        "formatted_start_end_time": "13:00 - 13:15",
        "class": ""
    },
    {
        "start_time": "13:15",
        ...
        "break_start_time": "",
        "break_end_time": "",
        "store_start_time": "13:15",
        "store_end_time": "13:30",
        "store_service_date": "2024-08-27",
        "is_booked": 0,
        "max_capacity": "1",
        "total_booked": 0,
        ...
        "formatted_start_time": "13:15",
        "formatted_end_time": "13:30",
        "formatted_start_end_time": "13:15 - 13:30",
        "class": ""
    },
    {
        "start_time": "13:30",
        ...
        "break_start_time": "",
        "break_end_time": "",
        "store_start_time": "13:30",
        "store_end_time": "13:45",
        "store_service_date": "2024-08-27",
        "is_booked": 0,
        "max_capacity": "1",
        "total_booked": 0,
        ...
        "formatted_start_time": "13:30",
        "formatted_end_time": "13:45",
        "formatted_start_end_time": "13:30 - 13:45",
        "class": ""
    },
    {
        "start_time": "13:45",
        ...
        "break_start_time": "",
        "break_end_time": "",
        "store_start_time": "13:45",
        "store_end_time": "14:00",
        "store_service_date": "2024-08-27",
        "is_booked": 0,
        "max_capacity": "1",
        "total_booked": 0,
        ...
        "formatted_start_time": "13:45",
        "formatted_end_time": "14:00",
        "formatted_start_end_time": "13:45 - 14:00",
        "class": ""
    }
]',true);
...
$horario['tarde']= json_decode('[]',true);

$dia_viernes['tarde']= json_decode('[]',true);
...
//182-RAMIREZ GABRIELA id:35 serv:17 Traumatología | 289-PADINI RUB id:32 serv:17 Traumatología | 
//
/** sin hacer 
 * 96-BARCIA id:7 serv:17 Traumatología | 
 */

$prestador = 96;//179
$medico_id = 7; //47 serv 17 Traumatología
$turno_man_tarde="mañana";//mañana tarde
$str_tarde= ($turno_man_tarde=='tarde')? "_tarde":"";
...
if( !empty(strstr((string) $datos_turno[$indx]['TURNO'], "MA")) ){
    $datos_turno[$indx]['TURNO'] = "MAÑANA";
}

if( $datos_turno[$indx]['ID_PRESTADOR'] == $prestador && (strtolower((string)$datos_turno[$indx]['TURNO'])==$turno_man_tarde) ){
    ...
    echo "<br />";
        ...
        $turno_en_horas = array();
        $turno_en_horas = !empty($horario[$turno_man_tarde][$nro_turno])? $horario[$turno_man_tarde][$nro_turno] :array();
        
        //Exapcion dia viernes
        $nomb_dia = date("D", strtotime($date));
         /*if( $nomb_dia == "Fri" ){
            
            $turno_en_horas = !empty($dia_viernes[$turno_man_tarde][$nro_turno])? $dia_viernes[$turno_man_tarde][$nro_turno] :array();
        }else{
            $turno_en_horas = !empty($horario[$turno_man_tarde][$nro_turno])? $horario[$turno_man_tarde][$nro_turno] :array();
        }*/
    
if( !empty($turno_en_horas) ){


        
        #print_r($turno_en_horas);
        echo "dia $nomb_dia hora {$turno_en_horas['start_time']}<br />";
//ob_start();
