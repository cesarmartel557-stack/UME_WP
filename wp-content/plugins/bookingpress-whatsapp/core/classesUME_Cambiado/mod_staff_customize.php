...
<div class="bpa-staff-sidebar-navigation" :class="(bpa_toggle_active == 1) ? '__bpa-is-active' : ''">
	...
	<div class="bpa-ssn__navbar-wrap">		
		<ul class="bpa-ssn__navbar">
			...
			<!--
			<li>
                <a href="javascript:void(0)" class="<?php echo ( 'appointments' == $request_module ) ? '__bpa-is-active' : ''; ?>">
				<!-- Comentado temporalmente para mostrar solo el link boton de historias
                <a href="<?php echo add_query_arg( 'page', $bookingpress_slugs->bookingpress_stories, esc_url( admin_url() . 'admin.php?page=bookingpress' ) ); // phpcs:ignore ?>" class="<?php echo ( 'appointments' == $request_module ) ? '__bpa-is-active' : ''; ?>">
