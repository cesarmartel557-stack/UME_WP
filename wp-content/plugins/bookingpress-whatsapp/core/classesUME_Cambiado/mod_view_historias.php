...
.bp_hc_is_expand .bpa-main-list-card__is-staff-custom-view {
    ...
    margin-top: 2px;
        ...
        .bphc_customer_background .personales>div {
            box-shadow: -2px 0 3px mediumslateblue;
            border-radius: 2px;
            padding: 4px;
        }
...
<el-main class="bpa-main-listing-card-container bpa-default-card bpa--is-page-non-scrollable-mob tws" :class="(bookingpress_staff_customize_view == 1 ) ? 'bpa-main-list-card__is-staff-custom-view':''" id="all-page-main-container">
    <style>
    ...
    <el-row class="bp_hc_expand_control">
...
<!--  --FILTRO-- Buscador por DNI -->
		<div class="bpa-table-filter is-align-right bp-hc-filter" >
			<el-row type="flex" :gutter="16" align="right" class="justify-end">
				<el-col :xs="24" :sm="12" :md="8" :lg="6" :xl="6" style="min-width: 240px;">
					<el-input class="bpa-form-control" v-model="dni_query" placeholder="Ingrese DNI"></el-input>
				</el-col>
				<el-col :xs="24" :sm="12" :md="8" :lg="6" :xl="6" align="right" style="min-width: 240px;">
                    <el-button class="bpa-btn bpa-btn__medium" @click="clearSearch">Limpiar</el-button>
					<el-button class="bpa-btn bpa-btn__medium bpa-btn--primary" :loading="patient_searching" @click="searchByDni" style="min-width:60px;">Buscar</el-button>
        ...
        <div v-if="selected_patient" style="margin: 4px;display: flex;gap: 10px;flex-wrap: wrap;">
    			...
    			<el-col class="bphc-patient-col"  :xs="24" :sm="24" :md="12" :lg="8" :xl="8" style="">
                    <div class="bphc_customer_card" style="margin-bottom:10px;">
                        ...
                        <div class="bphc_card">
                            <div class="header" style=""> <!--style="position: relative;"-->
                                ...
                                <strong>{{ (selected_patient.customer_firstname||'') + '&nbsp;' + (selected_patient.customer_lastname||'') }}</strong>
                    ...
                    <div class="bphc_customer_vitals  border rounded-md" style="box-shadow: 0 0 3px lightseagreen;margin-bottom: 10px;pading-right:10px;">
                        <div class="bphc_card" >
                            ...
                            <div class="body">
                            <!--card body-->
        <div class="space-y-4"> <div class="flex items-center justify-between"> <div class="flex items-center"> <div class="w-6 h-6 rounded-full bg-purple-100 flex items-center justify-center mr-2"> <i class="fas fa-ruler-vertical text-purple-500 text-xs"></i> </div> <span class="text-gray-500 uppercase text-xs">Altura</span> </div> <div class="flex items-center space-x-2"> <span class="font-medium">1.78</span> <span class="text-gray-400 text-sm">Mts</span> </div> </div> <div class="flex items-center justify-between"> <div class="flex items-center"> <div class="w-6 h-6 rounded-full bg-blue-100 flex items-center justify-center mr-2"> <i class="fas fa-weight text-blue-500 text-xs"></i> </div> <span class="text-gray-500 uppercase text-xs">Peso</span> </div> <div class="flex items-center space-x-2"> <span class="font-medium">74</span> <span class="text-gray-400 text-sm">Kg</span> </div> </div> <div class="flex items-center justify-between"> <div class="flex items-center"> <div class="w-6 h-6 rounded-full bg-yellow-100 flex items-center justify-center mr-2"> <i class="fas fa-calculator text-yellow-500 text-xs"></i> </div> <span class="text-gray-500 uppercase text-xs">IMI</span> </div> <div class="flex items-center space-x-2"> <span class="font-medium">23.4</span> <span class="text-gray-400 text-sm">BMI</span> </div> </div> <div class="flex items-center justify-between"> <div class="flex items-center"> <div class="w-6 h-6 rounded-full bg-green-100 flex items-center justify-center mr-2"> <i class="fas fa-thermometer-half text-green-500 text-xs"></i> </div> <span class="text-gray-500 uppercase text-xs">Temperatura</span> </div> <div class="flex items-center space-x-2"> <span class="font-medium">36.5</span> <span class="text-gray-400 text-sm">°C</span> </div> </div> <div class="flex items-center justify-between"> <div class="flex items-center"> <div class="w-6 h-6 rounded-full bg-teal-100 flex items-center justify-center mr-2"> <i class="fas fa-lungs text-teal-500 text-xs"></i> </div> <span class="text-gray-500 uppercase text-xs">Frec. Respiratoria</span> </div> <div class="flex items-center space-x-2"> <span class="font-medium">17</span> <span class="text-gray-400 text-sm">r/m</span> </div> </div> <div class="flex items-center justify-between"> <div class="flex items-center"> <div class="w-6 h-6 rounded-full bg-red-100 flex items-center justify-center mr-2"> <i class="fas fa-heartbeat text-red-500 text-xs"></i> </div> <span class="text-gray-500 uppercase text-xs">Presión Arterial</span> </div> <div class="flex items-center space-x-2"> <span class="font-medium">120/80</span> <span class="text-gray-400 text-sm">mmHg</span> </div> </div> <div class="flex items-center justify-between"> <div class="flex items-center"> <div class="w-6 h-6 rounded-full bg-pink-100 flex items-center justify-center mr-2"> <i class="fas fa-heart text-pink-500 text-xs"></i> </div> <span class="text-gray-500 uppercase text-xs">Frec. Cardíaca</span> </div> <div class="flex items-center space-x-2"> <span class="font-medium">62</span> <span class="text-gray-400 text-sm">Fc</span> </div> </div> </div>
                            <!--fin card body-->
                            </div>
                        </div>
                    </div>
        ...
        <!--
                            <div style="width: 100%;">
                                <span>{{ selected_patient.customer_metadata.persona_fecha }}</span>
                                <span>{{ selected_patient.customer_metadata.persona_genero }}</span>
                            </div>
                        -->
<!-- FIN LISTA PACIENTES (oculto por flujo DNI primero) -->
		...
		<!-- Vista sin resultados -->
			<el-row type="flex" v-if="items.length == 0" :class="(current_screen_size == 'desktop')?'w25min':''" >
		...
		<!-- Fin Vista sin resultados -->
			...
			<el-row v-if="items.length > 0" :class="(current_screen_size == 'desktop')?'w25min':''" >
				<el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
						...
						<div class="bpa-tc__wrapper"  >
							<el-table ref="multipleTable" :data="items" @selection-change="handleSelectionChange">
								...
								<el-table-column  prop="customer_fullname" label="<?php esc_html_e( 'Nombre', 'bookingpress-appointment-booking' ); ?>" sortable sort-by="customer_username">
									...
									<a class="link-paciente " @click="selectPatient(scope.row)" >
    ...
    <div class="el-row main-historias" >
        ...
        <div class="subt-historias" >
            ...
            <h2>Historias del Paciente</h2>
        </div>
        <div class="lista-historias-container">
        
            <div class="linea-tiempo">
            </div>
        
            <div class="lista-historias" >
                <div v-if="histories_loading" class="historia-item">
                    <strong>Cargando historias...</strong>
                </div>
                <div v-else-if="!selected_patient" class="historia-item">
                    <strong>Ingrese un DNI para ver las historias del paciente.</strong>
                </div>
                <div v-else-if="histories.length === 0" class="historia-item">
                    <strong>No hay historias para este paciente.</strong>
                </div>
                <div v-else v-for="h in histories" :key="h.id" class="historia-item" :data-historia="h.date_label">
                    <div>
                        <strong>{{ h.doctor || 'Medico' }}</strong>
                        <strong style="float: right;">{{ h.date }}</strong>
                    </div>
                    <br />
                    <div v-html="h.summary"></div>
                </div>
            </div>
        </div>
