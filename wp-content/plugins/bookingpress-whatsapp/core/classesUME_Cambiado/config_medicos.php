...
if ( $medico == 85 || isset($all_medicos) ): //"85" => DR MOMBELLI
...
elseif ( $medico == 70 || isset($all_medicos) ): //"70" => DRA GUTIERREZ
...
elseif ( $medico == 80 || isset($all_medicos) ): //"80" => DR BORISONIK
...
elseif ( $medico == 78 || isset($all_medicos) ): //"78" => DR PADINI
...
elseif ( $medico == 79 || isset($all_medicos) ): //79 => DR MARTINI ARIEL
...
elseif ( $medico == 96 || isset($all_medicos) ): //96 => DRA VILLAVERDE
