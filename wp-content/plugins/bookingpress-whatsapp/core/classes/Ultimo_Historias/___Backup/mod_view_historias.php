				...
				<el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
					<div class="bpa-data-empty-view" style="flex-direction: column;">
						...
						<div class="xxxbpa-ev-right-content">
							<h4><?php esc_html_e( 'No se encontro Paciente(s)', 'bookingpress-appointment-booking' ); ?></h4>
    ...
    <div  class="el-row main-historias " >
        ...
        <div class="flex w-full histories-listing-header" style="width: 100%;" >
            ...
            <div class="flex" style="align-self: flex-end;justify-self: end;padding-right: 10px;min-width: 380px;justify-content: end;">
                ...
                -->
                <?php $bphc_appointment_id = absint($_GET['appointment']);
                if( $bphc_appointment_id ){ ?>
                <el-tooltip v-if="bphc_appointment_history" effect="dark" content="" placement="top" open-delay="300">
                    <el-button v-if="bphc_appointment_history && selected_patient && (selected_patient.customer_id == bphc_appointment_history.customer_id)" class="bpa-btn bpa-btn--secondary" @click="bphc_edit_HystoryRecord(0, bphc_appointment_history, <?php echo $bphc_appointment_id; ?>, 1)"> 
                    ...
                    <div class="historia-item">
                        <div class="border-l-4 border-primary-400 bg-white rounded shadow-sm p-3 flex"> 
                            ...
                            <div class="bphc_inf_sname">
                                <div class="flex-col" style="flex-direction: column;">
                            ...
                            <div class="text-xs text-gray-500 bphc_inf_right">
                                <span class="the_history_time">{{ (moment((h.time||''), 'HH').format('hh:mm A'))!='invalid_date'? (moment((h.time||''), 'HH').format('hh:mm A')) :''}}</span>
                                
                                <span @click="bphc_edit_HystoryRecord(h.id, h)" class="bphc-action-buttons" style="cursor: pointer;justify-self:right;">
