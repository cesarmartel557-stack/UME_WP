  ...
  <div class="print-form-container">
    ...
    <header class="form-header">
      <div class="header-titles">
        <h2>UM-E <span class="subtitle">UNIDAD MÉDICA EDUCATIVA</span></h2>
        <h1>INTERNACIÓN - FORMULARIO DE INGRESO</h1>
      </div>
      <div class="header-meta">
        ...
        <div class="field-inline">
          <strong>Médico:</strong> <span>{{ form.medico_name || '___________________________' }}</span>
        </div>
      </div>
    </header>
...
<!-- 6. EXAMEN FÍSICO GENERAL -->
  ...
  computed: {
    ...
    paciente() {
      return this.form.selected_customer_data || {};
    },
    ef() {
