...
function bookingExpansion_enviar(send_opt = 'email'){
    ...
    //params.append('action', 'booking_Expansion_send_content');
    //params.append('booking_Expansion_action', 'booking_Expansion_send_content');
...
<div class="bphc-componente-impesion" style="text-align: center;display: flex;align-content: flex-start;art;flex-direction: column;align-items: center;justify-content: flex-start;"><!-- display: none;opacity: 0; -->
    <div class="impresion-buttons-container">
        ...
        <div>
            ...
            <div class="impresion-buttons__inner">
                ...
                <button onclick="bookingExpansion_enviar('email')">
