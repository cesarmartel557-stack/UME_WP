<div class="el-card" style="padding: 0;background: rgb(255, 255, 255);border: 0px solid rgb(204, 208, 212);width: 100%;box-sizing: border-box;">
<?php if( true || isset($_GET['ingresotest']) ){ ?>
<div v-if="typeof impre !='undefined' && impre" style="width: 100%;min-height: 200px;border: 1px solid greenyellow;">
           ...
           <el-row>
                <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" style="display: none;">
                    <h3 class="bpa-page-heading" style="margin-bottom: 10px;">
                        <span><!--Formulario de -->Ingreso </span>
                        <span > 
                            <span v-if="Number(ingreso_formdata.id)" class="bpa-page-heading" style="color: var(--bpa-dt-black-300);"> Nro. # {{ingreso_formdata.id}} </span>
...
<div :class="{ inhabilitado : !Number(ingreso_formdata.selected_customer) }" :style="{opacity:(!Number(ingreso_formdata.selected_customer)? '0.5':'')}" >
              ...
              <el-collapse-item title="5. ANTECEDENTES HEREDOFAMILIARES" name="5">
                ...
                <template>
                    ...
                    <el-row type="flex" align="right" style="margin-top: 30px; justify-content: right;">
