...
*/ ?>
          ...
          <div class="form-footer" style="border-radius:4px; border:1px solid var(--el-border-color-light);">
            ...
            -->
            */ ?>
            <button @click="obtenerConfiguracion" type="button" class="bpa-btn bpa-btn--secundary">Recuperar llenado</button>
            <el-button @click="()=>{ localStorage.setItem('last_inter_ing_formData', JSON.stringify(this.ingreso_formdata) ); this.$notify({type:'success', message:'Guardado Local'});  }" type="button" class="bpa-btn bpa-btn--primary">Guardar Ingreso →</el-button>
