...
//INTERNACION METODOS - CUSTOMER
            ...
            bookingpress_get_customer_list(query){
                ...
                if (query !== '') {
                    ...
                    .then(function(response){
                        vm2.bookingpress_loading = false;
                        let list = Array.isArray(response.data.appointment_customers_details)? response.data.appointment_customers_details.slice(0,20) : [];
                        vm2.ingreso_customers_list = list;                        
                    }).catch(function(error){
                        console.log(error)
                    });
                } else {
