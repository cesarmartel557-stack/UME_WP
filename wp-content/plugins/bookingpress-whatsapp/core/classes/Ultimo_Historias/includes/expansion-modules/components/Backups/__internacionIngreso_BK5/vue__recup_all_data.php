        ...
        watch: {
            ingreso_formdata: {
                handler( val ){
                    ...
                    console.log('ing', val)
                    this.guardarConfiguracion({from: 'auto_up', silence: 0, dif_auto: 1500, dif_start: 5500});
            ...
            guardarConfiguracion( setting = {from: '', silence: 0, dif_auto: 1500, dif_start: 2500} ) {
                ...
                if(setting.from == 'auto_up'){
                    ...
                    if( (currTime < (this.last_auto_save+(setting.dif_auto || 1000))) || (currTime < ( this.ingreso_start_time + (setting.dif_start||1500) )) ){
                        abort = 1;
                        console.log('temp save abortado.');
                        return;
                    }
                ...
                if( !abort ){
                    console.log('temp save......', (setting.dif_start||1500) );
