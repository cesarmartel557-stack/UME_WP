...
<div class="bpa-staff-sidebar-navigation" :class="(bpa_toggle_active == 1) ? '__bpa-is-active' : ''">
	<div class="bpa-ssn__brand-logoo">
		<a href="#" class="bpa-ssn-logo">
			<img src="<?php echo esc_url( wp_get_attachment_url( get_theme_mod('custom_logo') ) ); #src="https://foatconcept.com.ar/turnos/wp-content/uploads/2025/08/logo-svg.svg"; ?>" alt="" />
		</a>		
	</div>
