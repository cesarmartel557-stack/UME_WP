...
if (!function_exists('register_navwalker')) :
  function register_navwalker() {
    ...
    register_nav_menu('header-bottom-menu', 'Header Bottom menu');
...
//WP Pantalla de Login Personalizado:
...
function my_login_logo_url_title() {
  return 'Turnos Sanatorio Loma Linda';
}
add_filter( 'login_headertitle', 'my_login_logo_url_title' );



function my_login_stylesheet2 () {
  wp_enqueue_style( 'custom-admin', get_template_directory_uri() . '/css/cus-admin-css.css' );
}
//add_action( 'admin_enqueue_scripts', 'my_login_stylesheet2', 9999 );
...
function wpdocs_selectively_enqueue_admin_script () {
  wp_enqueue_script( 'my_custom_script', get_template_directory_uri() . '/js/cus-admin.js', array('jquery'), '1.0' );
}

add_action( 'admin_enqueue_scripts', 'wpdocs_selectively_enqueue_admin_script', 9999 );
